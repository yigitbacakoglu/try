	...
	$(function(){
		...
		$('.news-trigger').toggle(
			function() {
				...
				$(this).html('Collapse <img src="assets/images/button-arrow-up.png" alt="" class="collapse-arrow-up">');
			},
			function() {
	...
	jQuery(function(){
		$('.archive-trigger').toggle(
			function() {
				...
				$(this).html('<img src="assets/images/collapse-button-down.png" alt="" />');
			},
			function() {
				$(this).next().next().slideDown().parent().toggleClass("closed");
				$(this).html('<img src="assets/images/collapse-button-up.png" alt="" />');
			}
		);
	});
	/* End Archive Toggler */
